...
(
  ...
  function_definition_java     nvarchar(100)              NULL,
  create_dept         bigint                              NULL,
  create_by           bigint                              NULL,
  create_time         datetime2(7)                        NULL,
  update_by           bigint                              NULL,
...
(
  ...
  testcase_json       nvarchar(1000)                      NULL,
...
INSERT INTO problem_function_signature (id, problem_id, language, function_signature)
VALUES
  -- Two Sum
  (1, 1, 'JavaScript', 'var twoSum = function(nums, target)'),
  (2, 1, 'Java', 'public int[] twoSum(int[] nums, int target)'),
  (3, 1, 'PHP', 'function twoSum($nums, $target)'),
  (4, 1, 'C', 'int* twoSum(int* nums, int numsSize, int target, int* returnSize)'),
  (5, 1, 'C++', 'vector<int> twoSum(vector<int>& nums, int target)'),
  (6, 1, 'C#', 'public int[] TwoSum(int[] nums, int target)'),
  (7, 1, 'Python', 'def twoSum(self, nums: List[int], target: int) -> List[int]:'),
  (8, 1, 'Go', 'func twoSum(nums []int, target int) []int'),

  -- Reverse Linked List
  (9, 2, 'JavaScript', 'var reverseList = function(head)'),
  (10, 2, 'Java', 'public ListNode reverseList(ListNode head)'),
  (11, 2, 'PHP', 'function reverseList($head)'),
  (12, 2, 'C', 'struct ListNode* reverseList(struct ListNode* head)'),
  (13, 2, 'C++', 'ListNode* reverseList(ListNode* head)'),
  (14, 2, 'C#', 'public ListNode ReverseList(ListNode head)'),
  (15, 2, 'Python', 'def reverseList(self, head: Optional[ListNode]) -> Optional[ListNode]:'),
  (16, 2, 'Go', 'func reverseList(head *ListNode) *ListNode'),

  -- Jump Game
  (17, 3, 'JavaScript', 'var canJump = function(nums)'),
  (18, 3, 'Java', 'public boolean canJump(int[] nums)'),
  (19, 3, 'PHP', 'function canJump($nums)'),
  (20, 3, 'C', 'bool canJump(int* nums, int numsSize)'),
  (21, 3, 'C++', 'bool canJump(vector<int>& nums)'),
  (22, 3, 'C#', 'public bool CanJump(int[] nums)'),
  (23, 3, 'Python', 'def canJump(self, nums: List[int]) -> bool:'),
  (24, 3, 'Go', 'func canJump(nums []int) bool'),

  -- Valid Parentheses
  (25, 4, 'JavaScript', 'var isValid = function(s)'),
  (26, 4, 'Java', 'public boolean isValid(String s)'),
  (27, 4, 'PHP', 'function isValid($s)'),
  (28, 4, 'C', 'bool isValid(char* s)'),
  (29, 4, 'C++', 'bool isValid(string s)'),
  (30, 4, 'C#', 'public bool IsValid(string s)'),
  (31, 4, 'Python', 'def isValid(self, s: str) -> bool:'),
  (32, 4, 'Go', 'func isValid(s string) bool'),

  -- Search a 2D Matrix
  (33, 5, 'JavaScript', 'var searchMatrix = function(matrix, target)'),
  (34, 5, 'Java', 'public boolean searchMatrix(int[][] matrix, int target)'),
  (35, 5, 'PHP', 'function searchMatrix($matrix, $target)'),
  (36, 5, 'C', 'bool searchMatrix(int** matrix, int matrixSize, int* matrixColSize, int target)'),
  (37, 5, 'C++', 'bool searchMatrix(vector<vector<int>>& matrix, int target)'),
  (38, 5, 'C#', 'public bool SearchMatrix(int[][] matrix, int target)'),
  (39, 5, 'Python', 'def searchMatrix(self, matrix: List[List[int]], target: int) -> bool:'),
  (40, 5, 'Go', 'func searchMatrix(matrix [][]int, target int) bool'),

  -- Longest Palindromic Substring
  (41, 6, 'JavaScript', 'var longestPalindrome = function(s)'),
  (42, 6, 'Java', 'public String longestPalindrome(String s)'),
  (43, 6, 'PHP', 'function longestPalindrome($s)'),
  (44, 6, 'C', 'char* longestPalindrome(char* s)'),
  (45, 6, 'C++', 'string longestPalindrome(string s)'),
  (46, 6, 'C#', 'public string LongestPalindrome(string s)'),
  (47, 6, 'Python', 'def longestPalindrome(self, s: str) -> str:'),
  (48, 6, 'Go', 'func longestPalindrome(s string) string'),

  -- Zigzag Conversion
  (49, 7, 'JavaScript', 'var convert = function(s, numRows)'),
  (50, 7, 'Java', 'public String convert(String s, int numRows)'),
  (51, 7, 'PHP', 'function convert($s, $numRows)'),
  (52, 7, 'C', 'char* convert(char* s, int numRows)'),
  (53, 7, 'C++', 'string convert(string s, int numRows)'),
  (54, 7, 'C#', 'public string Convert(string s, int numRows)'),
  (55, 7, 'Python', 'def convert(self, s: str, numRows: int) -> str:'),
  (56, 7, 'Go', 'func convert(s string, numRows int) string'),

  -- Reverse Integer
  (57, 8, 'JavaScript', 'var reverse = function(x)'),
  (58, 8, 'Java', 'public int reverse(int x)'),
  (59, 8, 'PHP', 'function reverse($x)'),
  (60, 8, 'C', 'int reverse(int x)'),
  (61, 8, 'C++', 'int reverse(int x)'),
  (62, 8, 'C#', 'public int Reverse(int x)'),
  (63, 8, 'Python', 'def reverse(self, x: int) -> int:'),
  (64, 8, 'Go', 'func reverse(x int) int'),

  (65, 9, 'JavaScript', 'var myAtoi = function(s)'),
  (66, 9, 'Java', 'public int myAtoi(String s)'),
  (67, 9, 'PHP', 'function myAtoi($s)'),
  (68, 9, 'C', 'int myAtoi(char* s)'),
  (69, 9, 'C++', 'int myAtoi(string s)'),
  (70, 9, 'C#', 'public int MyAtoi(string s)'),
  (71, 9, 'Python', 'def myAtoi(self, s: str) -> int:'),
  (72, 9, 'Go', 'func myAtoi(s string) int'),

  (73, 10, 'JavaScript', 'var isPalindrome = function(x)'),
  (74, 10, 'Java', 'public boolean isPalindrome(int x)'),
  (75, 10, 'PHP', 'function isPalindrome($x)'),
  (76, 10, 'C', 'bool isPalindrome(int x)'),
  (77, 10, 'C++', 'bool isPalindrome(int x)'),
  (78, 10, 'C#', 'public bool IsPalindrome(int x)'),
  (79, 10, 'Python', 'def isPalindrome(self, x: int) -> bool:'),
  (80, 10, 'Go', 'func isPalindrome(x int) bool'),

  (81, 11, 'JavaScript', 'var isMatch = function(s, p)'),
  (82, 11, 'Java', 'public boolean isMatch(String s, String p)'),
  (83, 11, 'PHP', 'function isMatch($s, $p)'),
  (84, 11, 'C', 'bool isMatch(char* s, char* p)'),
  (85, 11, 'C++', 'bool isMatch(string s, string p)'),
  (86, 11, 'C#', 'public bool IsMatch(string s, string p)'),
  (87, 11, 'Python', 'def isMatch(self, s: str, p: str) -> bool:'),
  (88, 11, 'Go', 'func isMatch(s string, p string) bool'),

  (89, 12, 'JavaScript', 'var maxArea = function(height)'),
  (90, 12, 'Java', 'public int maxArea(int[] height)'),
  (91, 12, 'PHP', 'function maxArea($height)'),
  (92, 12, 'C', 'int maxArea(int* height, int heightSize)'),
  (93, 12, 'C++', 'int maxArea(vector<int>& height)'),
  (94, 12, 'C#', 'public int MaxArea(int[] height)'),
  (95, 12, 'Python', 'def maxArea(self, height: List[int]) -> int:'),
  (96, 12, 'Go', 'func maxArea(height []int) int'),

  (97, 13, 'JavaScript', 'var intToRoman = function(num)'),
  (98, 13, 'Java', 'public String intToRoman(int num)'),
  (99, 13, 'PHP', 'function intToRoman($num)'),
  (100, 13, 'C', 'char* intToRoman(int num)'),
  (101, 13, 'C++', 'string intToRoman(int num)'),
  (102, 13, 'C#', 'public string IntToRoman(int num)'),
  (103, 13, 'Python', 'def intToRoman(self, num: int) -> str:'),
  (104, 13, 'Go', 'func intToRoman(num int) string'),

  -- Roman to Integer
  (105, 14, 'JavaScript', 'var romanToInt = function(s)'),
  (106, 14, 'Java', 'public int romanToInt(String s)'),
  (107, 14, 'PHP', 'function romanToInt($s)'),
  (108, 14, 'C', 'int romanToInt(char* s)'),
  (109, 14, 'C++', 'int romanToInt(string s)'),
  (110, 14, 'C#', 'public int RomanToInt(string s)'),
  (111, 14, 'Python', 'def romanToInt(self, s: str) -> int:'),
  (112, 14, 'Go', 'func romanToInt(s string) int'),

  -- Longest Common Prefix
  (113, 15, 'JavaScript', 'var longestCommonPrefix = function(strs)'),
  (114, 15, 'Java', 'public String longestCommonPrefix(String[] strs)'),
  (115, 15, 'PHP', 'function longestCommonPrefix($strs)'),
  (116, 15, 'C', 'char* longestCommonPrefix(char** strs, int strsSize)'),
  (117, 15, 'C++', 'string longestCommonPrefix(vector<string>& strs)'),
  (118, 15, 'C#', 'public string LongestCommonPrefix(string[] strs)'),
  (119, 15, 'Python', 'def longestCommonPrefix(self, strs: List[str]) -> str:'),
  (120, 15, 'Go', 'func longestCommonPrefix(strs []string) string'),

  -- 3Sum
  (121, 16, 'JavaScript', 'var threeSum = function(nums)'),
  (122, 16, 'Java', 'public List<List<Integer>> threeSum(int[] nums)'),
  (123, 16, 'PHP', 'function threeSum($nums)'),
  (124, 16, 'C', 'int** threeSum(int* nums, int numsSize, int* returnSize, int** returnColumnSizes)'),
  (125, 16, 'C++', 'vector<vector<int>> threeSum(vector<int>& nums)'),
  (126, 16, 'C#', 'public IList<IList<int>> ThreeSum(int[] nums)'),
  (127, 16, 'Python', 'def threeSum(self, nums: List[int]) -> List[List[int]]:'),
  (128, 16, 'Go', 'func threeSum(nums []int) [][]int'),

  -- 3Sum Closest
  (129, 17, 'JavaScript', 'var threeSumClosest = function(nums, target)'),
  (130, 17, 'Java', 'public int threeSumClosest(int[] nums, int target)'),
  (131, 17, 'PHP', 'function threeSumClosest($nums, $target)'),
  (132, 17, 'C', 'int threeSumClosest(int* nums, int numsSize, int target)'),
  (133, 17, 'C++', 'int threeSumClosest(vector<int>& nums, int target)'),
  (134, 17, 'C#', 'public int ThreeSumClosest(int[] nums, int target)'),
  (135, 17, 'Python', 'def threeSumClosest(self, nums: List[int], target: int) -> int:'),
  (136, 17, 'Go', 'func threeSumClosest(nums []int, target int) int'),

  -- Letter Combinations of a Phone Number
  (137, 18, 'JavaScript', 'var letterCombinations = function(digits)'),
  (138, 18, 'Java', 'public List<String> letterCombinations(String digits)'),
  (139, 18, 'PHP', 'function letterCombinations($digits)'),
  (140, 18, 'C', 'char** letterCombinations(char* digits, int* returnSize)'),
  (141, 18, 'C++', 'vector<string> letterCombinations(string digits)'),
  (142, 18, 'C#', 'public IList<string> LetterCombinations(string digits)'),
  (143, 18, 'Python', 'def letterCombinations(self, digits: str) -> List[str]:'),
  (144, 18, 'Go', 'func letterCombinations(digits string) []string'),

  -- 4Sum
  (145, 19, 'JavaScript', 'var fourSum = function(nums, target)'),
  (146, 19, 'Java', 'public List<List<Integer>> fourSum(int[] nums, int target)'),
  (147, 19, 'PHP', 'function fourSum($nums, $target)'),
  (148, 19, 'C', 'int** fourSum(int* nums, int numsSize, int target, int* returnSize, int** returnColumnSizes)'),
  (149, 19, 'C++', 'vector<vector<int>> fourSum(vector<int>& nums, int target)'),
  (150, 19, 'C#', 'public IList<IList<int>> FourSum(int[] nums, int target)'),
  (151, 19, 'Python', 'def fourSum(self, nums: List[int], target: int) -> List[List[int]]:'),
  (152, 19, 'Go', 'func fourSum(nums []int, target int) [][]int'),

  -- Remove Nth Node From End of List
  (153, 20, 'JavaScript', 'var removeNthFromEnd = function(head, n)'),
  (154, 20, 'Java', 'public ListNode removeNthFromEnd(ListNode head, int n)'),
  (155, 20, 'PHP', 'function removeNthFromEnd($head, $n)'),
  (156, 20, 'C', 'struct ListNode* removeNthFromEnd(struct ListNode* head, int n)'),
  (157, 20, 'C++', 'ListNode* removeNthFromEnd(ListNode* head, int n)'),
  (158, 20, 'C#', 'public ListNode RemoveNthFromEnd(ListNode head, int n)'),
  (159, 20, 'Python', 'def removeNthFromEnd(self, head: Optional[ListNode], n: int) -> Optional[ListNode]:'),
  (160, 20, 'Go', 'func removeNthFromEnd(head *ListNode, n int) *ListNode'),

  -- Merge Two Sorted Lists
  (161, 21, 'JavaScript', 'var mergeTwoLists = function(list1, list2)'),
  (162, 21, 'Java', 'public ListNode mergeTwoLists(ListNode list1, ListNode list2)'),
  (163, 21, 'PHP', 'function mergeTwoLists($list1, $list2)'),
  (164, 21, 'C', 'struct ListNode* mergeTwoLists(struct ListNode* list1, struct ListNode* list2)'),
  (165, 21, 'C++', 'ListNode* mergeTwoLists(ListNode* list1, ListNode* list2)'),
  (166, 21, 'C#', 'public ListNode MergeTwoLists(ListNode list1, ListNode list2)'),
  (167, 21, 'Python', 'def mergeTwoLists(self, list1: Optional[ListNode], list2: Optional[ListNode]) -> Optional[ListNode]:'),
  (168, 21, 'Go', 'func mergeTwoLists(list1 *ListNode, list2 *ListNode) *ListNode'),

  -- Generate Parentheses
  (169, 22, 'JavaScript', 'var generateParenthesis = function(n)'),
  (170, 22, 'Java', 'public List<String> generateParenthesis(int n)'),
  (171, 22, 'PHP', 'function generateParenthesis($n)'),
  (172, 22, 'C', 'char** generateParenthesis(int n, int* returnSize)'),
  (173, 22, 'C++', 'vector<string> generateParenthesis(int n)'),
  (174, 22, 'C#', 'public IList<string> GenerateParenthesis(int n)'),
  (175, 22, 'Python', 'def generateParenthesis(self, n: int) -> List[str]:'),
  (176, 22, 'Go', 'func generateParenthesis(n int) []string'),

  -- Reverse Linked List
  (177, 23, 'JavaScript', 'var reverseList = function(head)'),
  (178, 23, 'Java', 'public ListNode reverseList(ListNode head)'),
  (179, 23, 'PHP', 'function reverseList($head)'),
  (180, 23, 'C', 'struct ListNode* reverseList(struct ListNode* head)'),
  (181, 23, 'C++', 'ListNode* reverseList(ListNode* head)'),
  (182, 23, 'C#', 'public ListNode ReverseList(ListNode head)'),
  (183, 23, 'Python', 'def reverseList(self, head: Optional[ListNode]) -> Optional[ListNode]:'),
  (184, 23, 'Go', 'func reverseList(head *ListNode) *ListNode'),

  -- Merge Intervals
  (185, 24, 'JavaScript', 'var merge = function(intervals)'),
  (186, 24, 'Java', 'public int[][] merge(int[][] intervals)'),
  (187, 24, 'PHP', 'function merge($intervals)'),
  (188, 24, 'C', 'int** merge(int** intervals, int intervalsSize, int* intervalsColSize, int* returnSize, int** returnColumnSizes)'),
  (189, 24, 'C++', 'vector<vector<int>> merge(vector<vector<int>>& intervals)'),
  (190, 24, 'C#', 'public int[][] Merge(int[][] intervals)'),
  (191, 24, 'Python', 'def merge(self, intervals: List[List[int]]) -> List[List[int]]:'),
  (192, 24, 'Go', 'func merge(intervals [][]int) [][]int');
