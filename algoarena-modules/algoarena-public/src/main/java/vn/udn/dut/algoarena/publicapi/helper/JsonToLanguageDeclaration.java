...
public class JsonToLanguageDeclaration {
        ...
        for (Map.Entry<String, JsonElement> entry : jsonObject.entrySet()) {
            ...
            if (value.isJsonPrimitive()) {
                if (value.getAsJsonPrimitive().isNumber()) {
                    ...
                    code.append(handlePrimitiveNumber(key, index, number, language, indexOfParams));
                } else if (value.getAsJsonPrimitive().isBoolean()) {
                    code.append(handlePrimitiveBoolean(key, index, value.getAsBoolean(), language, indexOfParams));
                } else if (value.getAsJsonPrimitive().isString()) {
                    code.append(handlePrimitiveString(key, index, value.getAsString(), language, indexOfParams));
                }
            } else if (value.isJsonArray()) {
                code.append(handleJsonArray(key, value.getAsJsonArray(), index, language, indexOfParams));
            }
        }
        return code.toString();
    }

    private static String handlePrimitiveNumber(String key, String index, Number number, String language, Integer indexOfParams) {
    ...
    private static String handlePrimitiveBoolean(String key, String index, boolean value, String language, Integer indexOfParams) {
        StringBuilder result = new StringBuilder();
        if (language.equals("java")) {
    ...
    private static String handlePrimitiveString(String key, String index, String value, String language, Integer indexOfParams) {
        StringBuilder result = new StringBuilder();
        if (language.equals("java")) {
    ...
    private static String handleJsonArray(String key, JsonArray jsonArray, String index, String language, Integer indexOfParams) {
