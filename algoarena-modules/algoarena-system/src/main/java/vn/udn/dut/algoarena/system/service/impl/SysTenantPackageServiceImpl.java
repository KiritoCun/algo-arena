...
import vn.udn.dut.algoarena.system.domain.SysTenant;
import vn.udn.dut.algoarena.system.domain.SysTenantPackage;
import vn.udn.dut.algoarena.system.domain.bo.SysTenantPackageBo;
import vn.udn.dut.algoarena.system.domain.vo.SysTenantPackageVo;
import vn.udn.dut.algoarena.system.mapper.SysTenantMapper;
import vn.udn.dut.algoarena.system.mapper.SysTenantPackageMapper;
import vn.udn.dut.algoarena.system.service.ISysTenantPackageService;
...
/**
 * Tenant package Service business layer processing
 *
 * @author HoaLD
 */
...
public class SysTenantPackageServiceImpl implements ISysTenantPackageService {
    ...
    public Boolean deleteWithValidByIds(Collection<Long> ids, Boolean isValid) {
        if(isValid){
            ...
            if (exists) {
                throw new ServiceException("Tenant package already used");
            }
        }
