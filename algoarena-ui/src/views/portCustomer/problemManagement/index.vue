        ...
        <template v-slot:body>
          ...
          >
            ...
            <el-form-item label="Độ khó" prop="difficulty" class="form-item-row">
              <el-input v-model="problemForm.difficulty" placeholder="Nhập" />
            </el-form-item>
...
import { ProblemVO, TestcaseVO, ProblemQuery, TestcaseQuery, ProblemForm } from '@/api/portCustomer/problemManagement/types';
...
const problemColumns = ref<GridColumn[]>([
  { prop: "title", name: 'problemManagement.columns.titleLb', size: 120, readonly: true, align: 'left' },
  { prop: "description", name: 'problemManagement.columns.descriptionLb', sortable: true, size: 120, readonly: true, align: 'left' },
  { prop: "difficulty", name: 'problemManagement.columns.difficultyLb', sortable: true, size: 100, readonly: true, align: 'right'  },
  { prop: "createTime", name: 'problemManagement.columns.createTimeLb', sortable: true, size: 160, readonly: true, formatter: 'datetime' },
  { prop: "remark", name: 'problemManagement.columns.remarkLb', sortable: true, size: 150, readonly: true, align: 'left' },
]);
...
const testcaseColumns = ref<GridColumn[]>([
  { prop: "inputData", name: 'problemManagement.testcaseColumns.inputDataLb', sortable: true, size: 100, align: 'center' },
  { prop: "expectedOutput", name: 'problemManagement.testcaseColumns.expectedOutputLb', sortable: true, size: 150, align: 'left' },
  { prop: "illustration", name: 'problemManagement.testcaseColumns.illustrationLb', sortable: true, size: 150, align: 'left' },
  { prop: "explanation", name: 'problemManagement.testcaseColumns.explanationLb', sortable: true, size: 150, align: 'left' },
  { prop: "isHidden", name: 'problemManagement.testcaseColumns.isHiddenLb', sortable: true, size: 150, align: 'center' },
  { prop: "remark", name: 'problemManagement.testcaseColumns.remarkLb', size: 150, align: 'left' }
]);
...
const problemFormRules: FormRules = {
  ...
  problemName: [{ required: true, trigger: "blur", message: "Tên phòng chiếu không được trống" }]
};
///////////////////////////////////////////////////////////////////////////////
// METHOD SECTION
///////////////////////////////////////////////////////////////////////////////
