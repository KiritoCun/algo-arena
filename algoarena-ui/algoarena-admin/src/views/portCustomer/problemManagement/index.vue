...
const problemColumns = ref<GridColumn[]>([
  ...
  { prop: "difficulty", name: 'problemManagement.columns.difficultyLb', sortable: true, size: 70, readonly: true, align: 'center'  },
...
const testcaseColumns = ref<GridColumn[]>([
  ...
  { prop: "illustration", name: 'problemManagement.testcaseColumns.illustrationLb', sortable: true, size: 140, align: 'left' },
  { prop: "explanation", name: 'problemManagement.testcaseColumns.explanationLb', sortable: true, size: 180, align: 'left' },
  { prop: "isHidden", name: 'problemManagement.testcaseColumns.isHiddenLb', sortable: true, size: 50, align: 'center' },
