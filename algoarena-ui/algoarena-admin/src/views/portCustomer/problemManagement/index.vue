    ...
    <template v-slot:dialog>
      <IrDialog :dialog="problemDialog">
        <template v-slot:body>
          ...
          >
            <el-form-item label="Bài thi" prop="examId" class="form-item-row">
              <el-select v-model="problemForm.examId" placeholder="Chọn bài thi">
                <el-option
...
// IMPORT COMPONENT
// IMPORT API
import { listProblem, getProblem, getTestcase, delProblem, addProblem, updateProblem, updateTestcase, listTestcase, updateTestcases } from '@/api/portCustomer/problemManagement';
import { listExam } from '@/api/portCustomer/examManagement';
// IMPORT TYPE
import { ProblemVO, TestcaseVO, ProblemQuery, TestcaseQuery, ProblemForm, TestcaseForm } from '@/api/portCustomer/problemManagement/types';
import { ExamVO } from '@/api/portCustomer/examManagement/types';
...
const problemFormRules: FormRules = {
  examId: [{required: true, trigger: "blur", message: "Bài thi là bắt buộc", }],
...
const fetchExam = async () => {
  const { rows } = await listExam();
  examOptions.value = rows;
}
/** Edit button action */
