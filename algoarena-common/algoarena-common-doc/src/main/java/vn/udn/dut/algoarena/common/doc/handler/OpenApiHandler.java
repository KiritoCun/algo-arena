package vn.udn.dut.algoarena.common.doc.handler;
 ...
 * Modify the source code function to enhance the use
 */
@Slf4j
        ...
        if (isAutoTagClasses(operation)) {
            ...
            if (javadocProvider.isPresent()) {
                ...
                if (StringUtils.isNotBlank(description)) {
                    ...
                    // Customize the part to modify the tag name using java annotations
