...
import vn.udn.dut.algoarena.customer.service.VnpayPaymentService;
...
import vn.udn.dut.algoarena.port.domain.vo.BookingDetailVo;
import vn.udn.dut.algoarena.port.domain.vo.BookingInfoVo;
import vn.udn.dut.algoarena.port.domain.vo.BookingVo;
...
public class BookingController {
	...
	public R<List<BookingInfoVo>> getBookings() {
		...
		for (BookingVo booking : bookings) {
			...
			AlgoArenaVo algoarena = algoarenaService.queryById(booking.getAlgoArenaId());
			...
			bookingInfo.setAlgoArenaName(algoarena.getAlgoArenaName());
